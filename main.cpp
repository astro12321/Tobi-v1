...
// g++ main.cpp -o main.out -lpcap -lpthread -lPcap++ -lPacket++ -lCommon++
// -fPIC -std=c++11 -O2 -g -Wall -I$HOME/PcapPlusPlus/Dist/header && ./main.out
...
int main(int argc, char *argv[]) {
    ...
    while (true) {
        ...
        // std::cout << "\nPacket " << ind << "." << std::endl << hexStr(buffer,
        // bytesRead) << std::endl;
